...
// =====================================================================================
Route::middleware('auth')->group(function () use ($SA, $AK, $APR, $APB, $APJ, $MNG) {
    ...
    // Bahan Baku & Penolong → super_admin, admin_produksi, admin_pembelian
    Route::middleware("role:$SA,$APR,$APB")->group(function () {
    ...
    // Supplier → super_admin, admin_pembelian
    Route::middleware("role:$SA,$APB")->group(function () {
        Route::resource('supplier', SupplierController::class);
    });

    // Mitra → super_admin, admin_penjualan
    Route::middleware("role:$SA,$APJ")->group(function () {
        Route::resource('mitra', MitraController::class);
    });

    // Produk → super_admin, admin_produksi, admin_penjualan
    Route::middleware("role:$SA,$APR,$APJ")->group(function () {
    ...
    // Aset Tetap → super_admin, admin_akuntansi
    Route::middleware("role:$SA,$AK")->group(function () {
    ...
    // Divisi & Overhead → super_admin, admin_produksi
    Route::middleware("role:$SA,$APR")->group(function () {
    ...
    // Akun → super_admin, admin_akuntansi
    Route::middleware("role:$SA,$AK")->group(function () {
    ...
    // Approval Pemakaian Bahan → super_admin, admin_produksi, admin_akuntansi
    Route::middleware("role:$SA,$APR,$AK")->group(function () {
    ...
    // HPP → super_admin, admin_produksi, admin_akuntansi
    Route::middleware("role:$SA,$APR,$AK")->group(function () {
    ...
    Route::middleware("role:$SA,$AK")->group(function () {
        ...
        Route::prefix('keuangan/hutang-usaha')->name('hutang-usaha.')->group(function () {
            ...
            Route::post('/{id_hutang}/bayar', [HutangUsahaController::class, 'bayar'])->name('bayar');
        });
    ...
    // Piutang → super_admin, admin_akuntansi, admin_penjualan
    Route::middleware("role:$SA,$AK,$APJ")->group(function () {
    ...
    // =====================================================================
    // PERSEDIAAN (Stock Opname & Kartu Persediaan)
    // =====================================================================
    Route::middleware("role:$SA,$APR,$APB,$APJ")->group(function () {
        ...
        Route::prefix('persediaan')->group(function () {
            Route::get('/bahan-baku', [KartuPersediaanController::class, 'indexBahanBaku'])->name('persediaan.baku');
            Route::get('/bahan-penolong', [KartuPersediaanController::class, 'indexBahanPenolong'])->name('persediaan.penolong');
            Route::get('/produk-jadi', [KartuPersediaanController::class, 'indexProdukJadi'])->name('persediaan.produk');
            Route::get('/konsinyasi', [PersediaanKonsinyasiController::class, 'index'])->name('persediaan.konsinyasi');
        });
    });
    ...
    // Laporan Produksi & HPP → super_admin, admin_produksi, admin_akuntansi, manajer
    Route::middleware("role:$SA,$APR,$AK,$MNG")->group(function () {
    ...
    // Laporan Keuangan → super_admin, admin_akuntansi, manajer
    Route::middleware("role:$SA,$AK,$MNG")->group(function () {
        ...
        Route::get('/laporan/hutang-usaha', [HutangUsahaController::class, 'laporan'])->name('laporan.hutang.index');
    });
