      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 font-medium">Kelola data transaksi penjualan historis resmi dari SO</p>
          </div>
          <button 
          ...
          >
            <Plus className="w-4 h-4"/> Buat Penjualan Dari SO
          </button>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-left">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider">No. Invoice</th>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider">Ref. No SO</th>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider">Tanggal</th>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider">Pelanggan</th>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">Metode</th>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider text-right">Grand Total</th>
                  <th className="px-6 py-3.5 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">Aksi</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 bg-white text-sm text-gray-700">
                {filteredInvoices.map((inv) => (
                  <tr key={inv.id_jual} className="hover:bg-gray-50/70 transition-colors">
                    <td className="px-6 py-4 font-bold text-red-900">{inv.no_jual}</td>
